...
sleep 3
var=$(pwd)
echo "ESTAMOS TERMINANDO A INSTALAÇÃO! VOCÊ GOSTARIA DE INSTALAR AS SEGUINTES EXTENSÕES DO GNOME-SHELL:"
ls $var/extencoes_gnome42
sleep 2
...
echo "OK. VOCÊ PODE INSTALAR MAIS TARDE A PARTIR DA LISTA DE EXTENSÕES CRIADA NA SUA PASTA PESSOAL."
bash ./write_ext_list.sh
fi
